...
# Clear the boot log after a short delay
t.clear()

# 2. The User Prompt and Output
...
# Fetch stats using the built-in utility (Requires GITHUB_TOKEN environment variable)
...
t.gen_text(text="furqan@homelab:~$ _", row_num=13, contin=True) # Blinking cursor effect
